...
import com.bia.bodhinew.School.UpdateCredentialsSchool;
...
public class SettingsStudentPage extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View RootView=  inflater.inflate(R.layout.student_settings_layout, container, false);
    ...
    public void onClick(View view) {
        ...
        {
            startActivity(new Intent(getContext(), UpdateCredentials.class));
        }
        ...
        if (view == Card_Logout)
        {
            ...
            try {
                outputStream = getActivity().openFileOutput("Bodhi_Login", Context.MODE_PRIVATE);
