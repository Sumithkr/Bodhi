...
import com.bia.bodhinew.Student.LoginActivity;
import com.bia.bodhinew.Student.MasterStudentActivity;
...
public class choose extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v == Student)
        {
            ...
            startActivity(new Intent(choose.this, LoginActivity.class));
        }

        if(v == School)
        {

            startActivity(new Intent(choose.this, LoginActivitySchool.class));
        }
    }
}
